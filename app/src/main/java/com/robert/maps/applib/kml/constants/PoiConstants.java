...
public interface PoiConstants {
	...
	public static final String HIKING_TRAILS = "hikingtrails";
	...
	public static final String STAT_getHikingTrailList = "SELECT hikingtrails.name, descr, trackid _id, cnt, TIME('2011-01-01', duration || ' seconds') as duration, round(distance/1000.0, 2) AS distance0, show, IFNULL(duration, -1) As NeedStatUpdate, '%s' as units, round(distance/1000/1.609344, 2) AS distance1 FROM hikingtrails LEFT JOIN activity ON activity.activityid = hikingtrails.activity ORDER BY ";
	public static final String STAT_getHikingTrailChecked = "SELECT name, descr, show, trackid, cnt, distance, duration, categoryid, activity, date, style FROM hikingtrails WHERE show = 1";
	public static final String STAT_getHikingTrail = "SELECT name, descr, show, cnt, distance, duration, categoryid, activity, date, style FROM hikingtrails WHERE trackid = @1";
	public static final String STAT_getHikingTrailPoints = "SELECT lat, lon, alt, speed, date FROM hikingtrailpoints WHERE trackid = @1 ORDER BY id";
	public static final String STAT_setHikingTrailChecked_1 = "UPDATE hikingtrails SET show = 1 - show * 1 WHERE trackid = @1";
	public static final String STAT_setHikingTrailChecked_2 = "UPDATE hikingtrails SET show = 0 WHERE show = 1";
	//******************
	...
	//modify by self 20160924
	public static final String STAT_deleteHikingTrail_1 = "DELETE FROM hikingtrailpoints WHERE trackid = @1";
	public static final String STAT_deleteHikingTrail_2 = "DELETE FROM hikingtrails WHERE trackid = @1";
	//******************
